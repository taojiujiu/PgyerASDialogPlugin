...
//                }
    ...
    public static boolean isZh(){
        Locale locale = Locale.getDefault();
        String language = locale.getLanguage();
        if(PgyASPluginKeysManager.instance().getLanguage() == null) {
        ...
        if(!PgyASPluginKeysManager.instance().getLanguage().isEmpty()) {
            if(PgyASPluginKeysManager.instance().getLanguage().equals("chinese")){
                return true;
            }else{
                return false;
            }
